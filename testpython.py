...
def test_move(lib, device_id, distance):
    print("\nShifting")
    result = lib.command_move(device_id, distance, 0)
    print("Result: " + repr(result))
...
lib.set_bindy_key(b"keyfile.sqlite")
...
# time.sleep(3)
# test_move(lib, device_id, startpos)
# test_move(lib, device_id,-16000)
# test_move(lib, device_id,-24000)
test_move(lib, device_id, 0)
