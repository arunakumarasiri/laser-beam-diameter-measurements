...
def sigmoidGaus(beamType, stepSize, linearPos):
    ...
    if beamType == 'VIS':
        ...
        return array_h_dydx, dydx_h, y_h_gaus, popt_h_gaus

def plottingComp(stepSize, linearPos):
    ...
    array_h_dydx_VIS, dydx_h_VIS, stepSize, y_h_gaus_VIS, popt_h_gaus_VIS, linearPos = sigmoidGaus('VIS', stepSize, linearPos)
    array_h_dydx_IR, dydx_h_IR, y_h_gaus_IR, popt_h_gaus_IR = sigmoidGaus('IR', stepSize, linearPos)
    ...
    plt.savefig(fr'C:\Users\aruna\Nextcloud\cyanophenol\supporting\Aruna\Beam diameter measurements\{date}\3333\{stepSize}_{linearPos}_comp.png', dpi=600)
